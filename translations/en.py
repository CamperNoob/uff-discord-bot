...
GRAFANA_IGNORE_PLAYER_ID_VARIABLE = "Player ID. Optional parameter, if player name is used. Always used if not empty"
GRAFANA_IGNORE_NAME_VARIABLE = "Player name. Optional parameter, if ID is used"
GRAFANA_IGNORE_VALUE_IGNORE = 'Hide'
GRAFANA_IGNORE_VALUE_UNIGNORE = 'Show'
GRAFANA_IGNORE_NEED_ID_OR_NAME = f"{ERROR_GENERIC}: no ID nor Name was provided. Either ID or Name should not be empty"
...
GRAFANA_IGNORE_MULTIPLE_IDS_FROM_NAME = f"{ERROR_GENERIC}: found multiple players with similar names. Please, use player ID. Found (id, name)"
...
GRAFANA_IGNORE_SUCCESS = "Database record was updated (ID, Name, Status)"