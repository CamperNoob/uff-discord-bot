...
GRAFANA_IGNORE_PLAYER_ID_VARIABLE = "Ідентифікатор гравця. Необов'язковий параметр, якщо вказується ім'я. Завжди використовується, якщо вказаний"
GRAFANA_IGNORE_NAME_VARIABLE = "Ім'я гравця. Необов'язковий параметр, якщо вказується ідентифікатор"
GRAFANA_IGNORE_VALUE_IGNORE = 'Приховати'
GRAFANA_IGNORE_VALUE_UNIGNORE = 'Показувати'
GRAFANA_IGNORE_NEED_ID_OR_NAME = f"{ERROR_GENERIC}: не надано ні Ідентифікатор ні Ім'я. Потрібно надати одне із них"
...
GRAFANA_IGNORE_MULTIPLE_IDS_FROM_NAME = f"{ERROR_GENERIC}: знайдено декілька гравців зі схожим іменем. Будь-ласка використайте ідентифікатор. Знайдено (Ідентифікатор, Ім'я)"
...
GRAFANA_IGNORE_SUCCESS = "Запис в базі даних було оновлено (Ідентифікатор, Ім'я, Статус)"