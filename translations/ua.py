...
MISSING_VOICE_ERROR_MULTIPLE_MATCHES_FIRST = f"{ERROR_GENERIC}: Знайдено декілька голосових каналів за вашим запитом"
MISSING_VOICE_ERROR_MULTIPLE_MATCHES_SECOND = f"Будь-ласка спробуйте вказати канал більш точно"
